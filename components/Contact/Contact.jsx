...
const Contact = () => {
    ...
    return (
        <section className="relative bg-white dark:bg-gray-950 py-16 sm:py-20 md:py-28 overflow-hidden">
            ...
            <div className="container mx-auto px-4 sm:px-6 relative z-10">
                <div className="max-w-4xl mx-auto text-center mb-12 sm:mb-20">
                    ...
                    >
                        ...
                        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-gray-900 dark:text-white mb-6 leading-tight">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 sm:gap-12 items-start">
                    ...
                    <div className="lg:col-span-4 space-y-6">
                        {contactInfo.map((info, index) => (
                            <motion.div
                                ...
                                className="bg-white dark:bg-gray-900 p-6 sm:p-8 rounded-[2rem] shadow-xl shadow-gray-100 dark:shadow-none border border-gray-100 dark:border-gray-800"
                            >
                                            ...
                                            {item.type === 'phone' ? (
                                                <div className="flex flex-col gap-2">
                                                    ...
                                                    <div className="flex gap-2">
                                                        <Button asChild variant="outline" className="flex-1 rounded-xl border-blue-100 hover:bg-blue-50 text-blue-600 dark:border-blue-900/30 dark:hover:bg-blue-900/20 text-xs sm:text-sm">
                                                            <a href={`tel:${item.value}`}>
                                                                <Phone className="w-4 h-4 mr-2" /> Call
                                                            </a>
                                                        </Button>
                                                        <Button asChild variant="outline" className="flex-1 rounded-xl border-emerald-100 hover:bg-emerald-50 text-emerald-600 dark:border-emerald-900/30 dark:hover:bg-emerald-900/20 text-xs sm:text-sm">
                                                ...
                                                >
                                                    <div className="w-8 h-8 rounded-lg bg-white dark:bg-gray-800 flex items-center justify-center mr-3 shadow-sm shrink-0">
                                                        <Mail className="w-4 h-4 text-emerald-600" />
                                                    </div>
                                                    <span className="text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-300 group-hover:text-emerald-700 dark:group-hover:text-emerald-400 truncate">
                                                        {item.label}
                                                    </span>
                                                </a>
                                            )}
                        ...
                        <motion.div
                            ...
                            className="bg-emerald-600 p-6 sm:p-8 rounded-[2rem] text-white relative overflow-hidden shadow-lg shadow-emerald-200 dark:shadow-none"
                        >
                    ...
                    <div className="lg:col-span-5">
                        <motion.div
                            ...
                            viewport={{ once: true }}
                            className="bg-white dark:bg-gray-900 p-6 sm:p-10 rounded-[2.5rem] shadow-2xl shadow-gray-200 dark:shadow-none border border-gray-100 dark:border-gray-800"
                        >
                ...
                >
                    <div className="absolute -inset-1 bg-gradient-to-r from-emerald-500 to-blue-500 rounded-[2rem] sm:rounded-[3rem] blur opacity-10 group-hover:opacity-20 transition duration-1000"></div>
                    <div className="relative h-[400px] sm:h-[500px] w-full overflow-hidden rounded-[2rem] sm:rounded-[3rem] bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 shadow-2xl">
                        <iframe 
                        ...
                        <div className="absolute bottom-4 left-4 right-4 sm:bottom-8 sm:left-8 sm:right-8 md:right-auto md:max-w-sm">
                            <div className="bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl p-6 sm:p-8 rounded-[1.5rem] sm:rounded-[2rem] shadow-2xl border border-white/20">
                                <div className="flex items-center gap-4 mb-4">
                                    <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-emerald-100 dark:bg-emerald-900/30 flex items-center justify-center text-emerald-600">
                                        <MapPin className="w-5 h-5 sm:w-6 sm:h-6" />
                                    </div>
                                    <div>
                                        <h4 className="font-bold text-sm sm:text-base text-gray-900 dark:text-white">Our Factory</h4>
                                        <p className="text-[10px] text-emerald-600 font-bold uppercase tracking-wider">Gazipur, Bangladesh</p>
                                    </div>
                                </div>
                                ...
                                <Button asChild className="w-full bg-emerald-600 hover:bg-emerald-700 text-white rounded-xl shadow-lg shadow-emerald-200 dark:shadow-none text-xs sm:text-sm h-11 sm:h-12">
                                    <a 
