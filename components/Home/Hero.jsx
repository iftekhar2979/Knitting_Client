...
const Hero = (props) => {
  return (
    <section className="back">
      ...
      <div
        data-aos="fade-right"
        className="container relative  mx-auto overflow-hidden  py-16 lg:px-8 lg:py-32 xl:max-w-6xl"
      >
        <div className="text-center ">
          <h2 className="mb-4 text-3xl font-black md:text-5xl fadeInLeftBig">
          ...
          <h3
            ...
            className="mx-auto  text-lg font-medium hero-detail md:text-xl md:leading-relaxed lg:w-2/3"
          >
            Premium Knit Fabrics for Every Design. <br/>Where Quality Meets Innovation in Textile Excellence
          </h3>
        </div>
        ...
        >
          ...
          <div
            className="absolute blob-animate right-0 top-0 -mr-16 -mt-20 h-32 w-32 rotate-3 rounded-xl bg-green-200 bg-opacity-50"
          ></div>
          <div
