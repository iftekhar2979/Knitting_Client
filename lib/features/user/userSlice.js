...
const initialState = {
  userInfo: null,
  path:['collections', 'manufacturing', 'sustainability', 'certifications', 'contact'],
  notify:0,
  isSidebarOpenOnDashboard:true
};
...
export const { setCredentials, removeCredentials,setNavbar,setDashboardMenu,setNotification,setSidebarOnDesboard, setSidebarVisibility } = authSlice.actions;
